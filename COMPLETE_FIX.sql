-- ====================================================================
-- COMPLETE FIX - Copy ALL of this and run in Supabase SQL Editor
-- ====================================================================
-- This will:
-- 1. Deploy the corrected function (2 meals = breakfast + lunch)
-- 2. Delete your old plan data
-- 3. Ready for you to regenerate plan in the app
-- ====================================================================

-- STEP 1: Deploy the corrected function
...
BEGIN
    ...
    -- ✓ FIXED: 2 meals = breakfast + lunch (NOT breakfast + dinner)
...
-- STEP 2: Delete your existing meal plan data
DELETE FROM public.user_meal_plan WHERE user_id = auth.uid();

-- ====================================================================
-- DONE! Now go to your app and:
-- 1. Navigate to Meal Plan page
-- 2. Complete the quiz with "2 meals" selected
-- 3. You should see BOTH breakfast and lunch for each day
-- ====================================================================
