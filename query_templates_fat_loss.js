...
async function fetchDistinctTemplates() {
    const url = `https://wewztpamzhrzbbgyutyf.supabase.co/rest/v1/program_templates?goal_code=eq.fat_loss&select=template_key,goal_code,training_location,training_days&limit=1000`;
    ...
    console.log("--- Fat Loss Templates ---");
