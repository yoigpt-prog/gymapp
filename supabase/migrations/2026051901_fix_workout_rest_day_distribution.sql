-- ============================================================
-- File    : 2026051901_fix_workout_rest_day_distribution.sql
-- Date    : 2026-05-19
-- CHANGE  : Updates resolve weekly split inside generate_user_workout_plan
--           to distribute rest days throughout the week instead of
--           grouping them at the end.
-- ============================================================
